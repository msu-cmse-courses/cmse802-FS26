...
Each milestone is submitted by updating the student’s Git repository and making the current milestone work visible there. Students should commit the relevant changes and keep the repository in a reviewable state. For the first milestone, students should also submit the URL to their repository through the course online form: 

[CMSE Project Registration – Fill out form](https://forms.cloud.microsoft/r/KR51WhT02B). 

The link should open the repository’s main landing page on GitHub or GitLab so the instructor can access the project directly.
